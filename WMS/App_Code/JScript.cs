...
public class JScript
{
    ...
    public static void ShowMessage(UpdatePanel p, string Message)
    {
    ...
    public static void RegisterScript(Page page, string ScriptContent)
    {
    ...
    public static void RegisterScript(UpdatePanel p, string ScriptContent)
    {
    ...
    //陈添
    public static void NavigationInfo(Page page, string operation, string NewPageUrl, bool IsModal)
    {
    ...
    //陈添
    public static void BackToTwoLevel(Page page, string NewPageUrl, bool IsModal)
    {
        string strScript = "<script> ";
        if (!IsModal)
        {
    ...
    //施加
    public static void SaveBack(Page page, string strText,/* string NewPageUrl,*/ bool IsModal)
    {
    ...
    //陈添
    public static void RegisterAjaxScript(Page page, string strControlID, string strRequestDate, string strProcessUrl, string strGetRequestDate, int iRow, int iCell, string strErrMsg)
    {
    ...
    //陈添
    public static void RegisterAjaxScript(Page page, string strControlID, string strRequestDate, string strProcessUrl, string strGetRequestDate, int iRow, int iCell, string strErrMsg, string OldID)
    {
        string strtime2 = DateTime.Now.Millisecond.ToString() + p.ToString();
        string strScript = "";
        strScript += "<script>";
