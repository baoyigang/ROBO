        ...
        <script type="text/javascript">
            ...
            function BindEvent() {
                $("[ID$='btnCellCode']").bind("click", function () {
                    ...
                    var where = "AreaCode='" + $('#ddlAreaCode').val() + "' and IsLock=0 and PalletBarCode='' and IsActive=1 and CellCode not in (" + strCellCode + ") ";
                    GetOtherValue('CMD_Cell', txtID.replace("btnCellCode", "NewCellCode"), 'CellCode', where);
            ...
            function AddDetail() {
                ...
                strCellCode += "'-1'";
                var where = "AreaCode='" + $('#ddlAreaCode').val() + "' and IsLock=0 and PalletBarCode !='' and CellCode not in (" + strCellCode + ") ";
