<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InventoryEdit.aspx.cs" Inherits="WebUI_Stock_InventoryEdit" %>
    ...
    <title></title>
        ...
        <script type="text/javascript">
            ...
            function AddDetail() {
                ...
                strCellCode += "'-1'";
                var where = "AreaCode='" + $('#ddlAreaCode').val() + "' and IsLock=0 and IsActive=1 and palletBarcode !='' and CellCode not in (" + strCellCode + ") ";
                    ...
                    <asp:GridView ID="dgViewSub1" runat="server" AutoGenerateColumns="False" SkinID="GridViewSkin"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="序号">
                             ...
                             <asp:BoundField DataField="BarCode" HeaderText="托盘编号" SortExpression="BarCode">
