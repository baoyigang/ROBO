<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InStockView.aspx.cs" Inherits="WebUI_InStock_InStockView" %>
                        ...
                        <td align="right">
                            ...
                            <asp:Button ID="btnEdit" runat="server" Text="修改" CssClass="ButtonModify" 
                             ...
                             <asp:Button ID="btnCheck" runat="server" Text="审核" CssClass="ButtonAudit" onclick="btnCheck_Click"  />
                              <asp:Button ID="btnTask" runat="server" Text="入库作业" CssClass="ButtonTask" 
                                onclick="btnTask_Click"  />
                               <asp:Button ID="btnUnTask" runat="server" Text="取消作业" 
                                CssClass="ButtonUnTask" onclick="btnUnTask_Click"  />
