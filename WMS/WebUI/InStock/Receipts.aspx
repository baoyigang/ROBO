<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Receipts.aspx.cs" Inherits="WebUI_InStock_Receipts"  culture="auto" uiculture="auto" MaintainScrollPositionOnPostback="true" %>
                ...
                <div>
                    ...
                    <tr>
						    ...
						    <td  width="15%" height="20">&nbsp;<asp:dropdownlist id="ddlField" runat="server" Width="85%" >
                                    ...
                                    <asp:ListItem Value="BillID">收货单号</asp:ListItem>
                ...
                <div id="divMain" style="overflow: auto; WIDTH: 100%; HEIGHT: 200px" onscroll="javascript:RecordPostion(this);">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" SkinID="GridViewSkin" Width="100%" OnRowDataBound="GridView1_RowDataBound">
                        <Columns>
                           ...
                           <asp:TemplateField HeaderText="收货单号" SortExpression="BillID">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="收货日期" SortExpression="BillDate">
                                <ItemTemplate>
