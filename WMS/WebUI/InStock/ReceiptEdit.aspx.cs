...
public partial class WebUI_InStock_ReceiptEdit : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            else
            {
                ...
                txtBillDate.changed = "$('#txtID').val(autoCodeByTableName('RS', '1=1','WMS_BillMaster', 'txtBillDate'));";
                this.txtBillDate.DateValue = DateTime.Now;
                this.txtID.Text = bll.GetAutoCodeByTableName("RS", "WMS_BillMaster", DateTime.Now, "1=1");
