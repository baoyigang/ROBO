<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OutStockView.aspx.cs" Inherits="WebUI_OutStock_OutStockView" %>
                 ...
                 <table  style="width: 100%; height: 25px;" class="OperationBar">
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <asp:Button ID="btnTask" runat="server" Text="出库作业" CssClass="ButtonTask" onclick="btnTask_Click"  />
                 ...
                 <div id="Sub-container" style="overflow: auto; width: 100%; height: 280px" >
                    <asp:GridView ID="dgViewSub1" runat="server" AutoGenerateColumns="False" SkinID="GridViewSkin"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ModelNo" HeaderText="规格" SortExpression="ModelNo">
                                <ItemStyle HorizontalAlign="Left" Width="15%" Wrap="False" />
                                <HeaderStyle Wrap="False" />
                            </asp:BoundField>
