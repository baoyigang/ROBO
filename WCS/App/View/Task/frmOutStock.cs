...
namespace App.View.Task
{
    public partial class frmOutStock : BaseForm
    {
        ...
        private void BindData()
        {
            ...
            DataTable dt = bll.FillDataTable("WCS.SelectTask", new DataParameter[] { new DataParameter("{0}", string.Format("WCS_TASK.State in('0','1','2','3') and WCS_TASK.TaskType='12' and SUBSTRING(palletCode,1,1){0}'a'",PalletCodeSub)) });
